...
final class PublicWhatsNewControllerTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_whats_new_page(): void
    {
    ...
    public function test_authenticated_user_can_mark_version_as_read(): void
    {
        $user = User::factory()->create();
    ...
    public function test_mark_as_read_with_invalid_version_id(): void
    {
        $user = User::factory()->create();
