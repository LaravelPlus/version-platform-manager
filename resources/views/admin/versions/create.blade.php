...
@section('content')
<div id="create-version-app" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <!-- Page Header -->
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Create Platform Version</h1>
                <p class="mt-2 text-sm text-gray-600">Add a new platform version</p>
            </div>
    ...
    methods: {
        ...
        exportMarkdown() {
            if (this.whatsNewMarkdown.trim()) {
                ...
                a.href = url;
                a.download = `whats-new-v${this.form.version || 'new'}.md`;
