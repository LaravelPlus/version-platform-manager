...
return new class() extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('platform_versions')) {
        ...
        if (!Schema::hasTable('whats_new')) {
            Schema::create('whats_new', function (Blueprint $table): void {
                $table->id();
        ...
        if (!Schema::hasTable('user_versions')) {
            Schema::create('user_versions', function (Blueprint $table): void {
                $table->id();
